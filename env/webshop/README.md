...
* Installs the Java runtime required by the search engine (pyserini)
* Downloads product and instruction data for populating WebShop (mirrored on [Hugging Face](https://huggingface.co/datasets/sparklabutah/timewarp-env-data))

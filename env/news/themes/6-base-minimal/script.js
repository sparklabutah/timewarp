...
// Console message
console.log('%c📰 News Reader', 'font-size: 24px; font-weight: bold; color: #c40000;');
console.log('%cLocal News interface - Content from Wikimedia Foundation', 'font-size: 12px; color: #666;');

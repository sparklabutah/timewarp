...
test_benchmark.env_args_list = test_benchmark.env_args_list[240:309]
...
study.dir = Path(f"results/{model_name_for_dir}/{args.version}_multiTest")  # Separate directory to avoid mixing with other results

...
test_benchmark.env_args_list = test_benchmark.env_args_list[93:159]
...
study.dir = Path(f"results/{model_name_for_dir}/{args.version}_newsTest")  # Separate directory to avoid mixing with other results
